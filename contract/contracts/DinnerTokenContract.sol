...
contract DinnerCreditsToken is ERC20, Ownable, Tradable, ReentrancyGuard, Donatable {

    CentralizedVault private vault;

    event CreditClaimed(address indexed claimer);

    constructor(address vaultAddress) ERC20("Dinner Tokens", "DINNER") Ownable(msg.sender) {
